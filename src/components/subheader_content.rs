    ...
    rsx! {
        div { class: "pb-4",
            ...
            match (volume_id, part_id, chapter_id, section_id, subheader_id) {
                ...
                // Start of volume 1, part 2, chapter 7, section 2
                (1, 2, 7, 2, 1) => rsx! {
                ...
                // Start of volume 1, part 3, chapter 8, section 1
                (1, 3, 8, 1, 1) => rsx! {
                ...
                // Start of volume 1, part 3, chapter 8, section 2
                (1, 3, 8, 2, 1) => rsx! {
                ...
                // Start of volume 1, part 3, chapter 8, section 3
                (1, 3, 8, 3, 1) => rsx! {
