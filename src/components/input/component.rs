//! I modified this module because there's a problem with merging the class attributes.
//! I added:
//! use dioxus_primitives::dioxus_attributes::attributes;
//! use dioxus_primitives::merge_attributes;
//! and then the base and merged variables
//! 
//! I modeled the change after the dioxus button component setup.
